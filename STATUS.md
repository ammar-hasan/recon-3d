...
- Safety violations: **0**.
- Regression suite: **252 passed, 1 skipped**, including real Blender build,
...
- Ten of eleven required stage ablations now have executable configs; status
  and the remaining uncertainty-tracking control are documented in
...
The latest test run produced `252 passed, 1 skipped`. The single-view E2E run produced
